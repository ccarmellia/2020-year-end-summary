...
const Papers = (props) => {
  ...
  const fetchData = async () => {
    ...
    if (true) {
      const [papersRes, todoRes, myRes] = await Promise.all([
        axios.get("https://annual-review-api.ncuos.com/data", {
          headers: { Authorization: `passport ${token}` },
        }),
        axios.get("http://incu-api.ncuos.com/v2/api/todo", {
          headers: { Authorization: token },
        }),
        axios.get("http://incu-api.ncuos.com/v2/api/todo/my", {
          headers: { Authorization: token },
        }),
      ]);
      ...
      const papers = [
        {
          ...
          context: (
            <div>
              {data.page1.join_year !== null
                ? data.page1.join_year
                : "没找到哦"}
              年
              {data.page1.join_month !== null
                ? data.page1.join_month
                : "没找到哦"}
              月<br />
              南昌大学正式与你相遇
              <br />
              ...
              <br />
              已经见证你
              {data.page1.semester_spent !== null
                ? data.page1.semester_spent
                : "没找到哦"}
              个学期的大学生活
            </div>
          ),
        },
        {
          ...
          context: (
            <div>
              ...
              <br />
              你见过南大
              {data.page3.pass_days !== null
                ? data.page3.pass_days
                : "没找到哦"}
              个夜晚里形状各异的月亮
              <br />
              坐在教室里
              <br />
              听了
              {data.page3.total_course_hours !== null
                ? data.page3.total_course_hours
                : "没找到哦"}
              次上课铃
            </div>
          ),
          ...
          context:
            Boolean(data.page4.if_grade_20) === true ? (
              <div>
                ...
                <br />
                你考的最好的课程有：
                {data.page4.page_4_data.top_three_courses !== null
                  ? data.page4.page_4_data.top_three_courses.map(
                      (item, index) => (
                        <span key={index}>
                          <br />
                          {item.class_name}
              ...
              <div>
                ...
                <br />
                高达
                {data.page4.page_4_data.credits_taken !== null
                  ? data.page4.page_4_data.credits_taken
                  : "没找到哦"}
                的学分
                <br />
                没有辜负你
                ...
                这个学期的课业圆满完成
                <br />
                {data.page4.page_4_data.gpa !== null
                  ? data.page4.page_4_data.gpa
                  : "没找到哦"}
                平均绩点
                <br />
                也在肯定着你的努力
            ...
            Boolean(data.page4.if_grade_20) === true ? (
              <div>
                ...
                {data.page4.page_4_data.top_three_courses[0].class_name !== null
                  ? data.page4.page_4_data.top_three_courses[0].class_name
                  : "没找到哦"}
                <br />
                超过了全专业
                {data.page4.page_4_data.course_defeat_rank !== null
                  ? data.page4.page_4_data.course_defeat_rank
                  : "没找到哦"}
                %的同学
                <br />
                不用担心啦
        ...
        },
        {
          ...
          context: (
            <div>
              {data.page2.join_year !== null
                ? data.page2.join_year
                : "没找到哦"}
              年9月
              {data.page2.first_class_day !== null
                ? data.page2.first_class_day
                : "没找到哦"}
              日<br />你
              {data.page2.first_class_address !== null &&
              data.page2.first_class_address !== "NULL"
                ? "在" + data.page2.first_class_address
                : ""}
              上了大学的第一堂课
            </div>
          ),
        },
        {
          ...
          context: (
            <div>
              在那儿
              <br />
              {data.page2.first_class_teacher !== null
                ? data.page2.first_class_teacher
                : "没找到哦"}
              老师与你初见
              <br />
              也许在毕业季,
              ...
              你还会想重温那天那节
              <br />
              {data.page2.first_class_name !== null
                ? data.page2.first_class_name
                : "没找到哦"}
            </div>
          ),
        },
        ...
        },
        {
          ...
          context: (
            <div>
              ...
              在南大app里
              <br />
              你参与的习惯有{my.length > 0 ? my[0].title : "无"}{" "}
              {my.length > 1 ? my[1].title + "等" : ""}
              <br />
              {my.length > 0
                ? "其中坚持" + my[0].title + "长达" + my[0].check_count + "天"
                : ""}
            </div>
          ),
        },
        ...
        },
        {
          ...
          context: (
            <div>
              ...
              成为了习惯圈子里的王者
              <br />
              {other[0].title}: {other[0].count}人 <br />
              {other[1].title}: {other[1].count}人 <br />
              {other[2].title}: {other[2].count}人
            </div>
          ),
        },
        // 有一个判断
  ...
  const flip = () => {
    ...
    setTimeout(function () {
      document.getElementById("paper-before").style.visibility = "hidden";
    }, 0);
  };
  const unflip = () => {
    ...
    setTimeout(function () {
      document.getElementById("unflip").style.visibility = "hidden";
    }, 0);
  };
        ...
        <div className="paper-before" id="paper-before">
          <div
            ...
            onClick={() => {
              dispatch({
                type: UPDATE_SHOW,
                show: { show: true, index: show.index, play: true },
              });
            }}
          ></div>
          {show.index > 0 ? (
            <img
              id="before"
              className="sway"
              src={require("../assets/imgs/yaozhui.png")}
              onClick={flip}
            ></img>
          ) : (
            ""
